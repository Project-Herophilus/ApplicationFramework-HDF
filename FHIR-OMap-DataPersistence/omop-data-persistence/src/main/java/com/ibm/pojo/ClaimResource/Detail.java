...
public class Detail {
    ...
    public List<SubDetail> subDetail;
    ...
    public List<SubDetail> getSubDetail(){return subDetail;}
    public void setSubDetail(List<SubDetail> subDetail){this.subDetail=subDetail;}
