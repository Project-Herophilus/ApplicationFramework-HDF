...
#
# docker build -f src/main/docker/Dockerfile.native -t quarkus/fhir-panache-persist .
#
# Then run the container using:
#
# docker run -i --rm -p 8080:8080 quarkus/fhir-panache-persist
#
###
...
NAME="fhir-persist"
IMAGE="us.icr.io/clinical_data_platform/fhir-persist:$PIPELINE_STAGE_INPUT_REVS"
if [ -z IMAGE ]; then
